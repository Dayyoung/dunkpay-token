...
이 문서는 DunkPay 토큰 판매에 관련한 글 입니다. DunkPay는 현재 암호화폐를  이용하여 결제할 수 있는 서비스 입니다. 사용자가 DunkPay를 통하여 결제를 진행하면 구매 수수료를 부과 합니다. 또한 우리는 DunkPay를 응용하여 오프라인과 연계하는 서비스를 개발 하고 있습니다. 우리는 DunkPay의 서비스 운영수익을 토큰으로 판매하기로 결정 하였습니다. DunkPay는 운영 중인 서비스 입니다. 특정한 판매기간 이나 제약사항을 걸지 않습니다. 언제든지 환불도 가능합니다.
...
매월 첫날에 홈페이지를 통해서 집행내용을 공개합니다.

# 최고의 시나리오

DunkPay가 성공적으로 판매가 된다면 암호화폐의 대중화에 기여하여 수익을 극대화 하도록 하겠습니다. 모금된 수익은 다시 암호화폐 결제서비스 개발에 사용하겠습니다. 자영업자를 위한 POS(Point Of Sale) 장비를 도입 하겠습니다. 자영업자로 연결되는 ATM(Automatic Teller Machine) 서비스도 진행하겠습니다. 궁극적으로는 중앙화된 거래소의 현재 문제를 개선한 사용자 우선의 저수수료 DEX(Decentralized Exchange) 개발도 진행하도록 하겠습니다.
